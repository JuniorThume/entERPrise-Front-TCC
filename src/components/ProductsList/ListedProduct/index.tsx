...
const ListedProduct = ({ product }: IShapeProductProps) => {
  ...
  return (
    <li className="text-sm mg-4 p-1 border border-black rounded-2xl text-black grid grid-cols-7 items-center m-2 font-list_product">
      ...
      <div className="flex ">
        ...
        <EditProductModal />
        <button className="bg-main rounded-md bg-remove p-1 mx-1">
